...
var cards = [
  {
	...
	<table>
		<tbody>
			...
			<tr>
				<td>Email</td>
				<td><a href="mailto:juanfg7007@gmail.com">juanfg7007@gmail.com</a></td>
			</tr>
			<tr>
				<td>Teléfono</td>
			...
			<tr>
				...
				<td><a href="/resume/Juan F González CV v08.pdf" download>Descargar C.V.</a></td>
			</tr>
			<tr>
				<td>Portfolio</td>
				<td><a href="https://multikitty-portfolio.onrender.com" target="_blank">Ver Portfolio</a></td>
			</tr>
			<tr>
				<td>Contacto</td>
				<td>
					<a href="mailto:multikitty422@gmail.com"><i class="fas fa-envelope"></i></a>
					<a href="https://join.skype.com/invite/ASrp28fNbxlh"><i class="fab fa-skype"></i></a>
					<a href="https://t.me/multikitty"><i class="fab fa-telegram"></i></a>
					<a href="https://github.com/multikitty" target="_blank"><i class="fab fa-github"></i></a>
				</td>
			</tr>
		</tbody>
	</table>
    ...
    html: `<table>
      <tbody>
        <tr>
          ...
          <td>IFCD0211 - Sistemas de Gestión de la Información</td>
          <td>2023-2024</td>
          <td>Coremsa Formación</td>
        </tr>
				<tr>
          <td>Certificado Profesional</td>
          <td>SSCE0110 - Docencia de la Formación Profesional para el Empleo</td>
          <td>2023-2024</td>
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr>
          ...
          <td>feb '18<br>ene '19</td>
          <td><a href="#" onclick="modal(event)" data-title="Arter Oy">+ info</a></td>
        </tr>
			</tbody>
		</table>`,
  },
